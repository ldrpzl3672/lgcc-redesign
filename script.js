...
(function () {
  ...
  function isGolfEvent(ev) {
    ...
    return SOCIAL_TYPES.indexOf(t) === -1;
  }
    ...
    if (ev.bannerImage || ev.banner_url) {
      ...
      bannerHtml =
        '<div class="schedule-banner">' +
          ...
          'style="width:100%;max-height:160px;object-fit:cover;border-radius:8px 8px 0 0;display:block;" ' +
  ...
  function init() {
    ...
    fetch("/data/upcoming-events.json?v=" + Date.now())
      ...
      .catch(function () {
        renderGolfEvents(golfContainer, []);
      });
  }
